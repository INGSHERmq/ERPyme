  ...
  return (
    <div className="module-container">
      ...
      <nav className="tabs-nav" role="tablist">
        ...
        <button role="tab" aria-selected={tab === 'egresos'} className={tab === 'egresos' ? 'active' : ''} onClick={() => setTab('egresos')}>💸 Egresos</button>
        <button role="tab" aria-selected={tab === 'cuentas'} className={tab === 'cuentas' ? 'active' : ''} onClick={() => setTab('cuentas')}>📋 Cuentas por Cobrar</button>
      </nav>
