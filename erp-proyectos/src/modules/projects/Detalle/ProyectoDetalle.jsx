  ...
  return (
    <div className="proyecto-detalle">
      ...
      <nav className="detalle-tabs">
        ...
        <button className={tab === 'calendario' ? 'active' : ''} onClick={() => setTab('calendario')}>🗓️ Calendario</button>
        <button className={tab === 'personal' ? 'active' : ''} onClick={() => setTab('personal')}>👥 Personal</button>
        <button className={tab === 'herramientas' ? 'active' : ''} onClick={() => setTab('herramientas')}>🛠️ Herramientas</button>
      </nav>
